...
# Version: 0.1                                                                    
# Usage: rosrun gem_stanley_siefm stanley_sim.py                                                                    
# Python version: 3.8                                                             
#================================================================
...
class Stanley(object):
	...
	def __init__(self):
		...
		self.lateral_gazebo_error                  = 0.0
		self.heading_gazebo_error                  = 0.0
		self.repos 								   = 0
	...
	def read_waypoints(self):
		...
		filename = os.path.join(dirname, 'waypoints/waypoints_Spiral_5.csv')
